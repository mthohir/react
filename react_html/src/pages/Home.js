      ...
      <div>
        <div className="row masonry-wrap">
            <div className="masonry">
                ...
                <article className="masonry__brick entry format-gallery" data-aos="fade-up">
                    ...
                    <div className="entry__text">
                        <div className="entry__header">
                            ...
                            <h1 className="entry__title"><a href="single-gallery.html">Workspace Design Trends and Ideas.</a></h1>
                ...
                <article className="masonry__brick entry format-audio" data-aos="fade-up">
                    ...
                    <div className="entry__text">
                        <div className="entry__header">
                            ...
                            <h1 className="entry__title"><a href="single-audio.html">What Your Music Preference Says About You and Your Personality.</a></h1>
                ...
                <article className="masonry__brick entry format-link" data-aos="fade-up">
